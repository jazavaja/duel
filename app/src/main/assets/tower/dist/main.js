!function (e) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.moveDownMovement = t.tutorialMovement = t.lightningMovement = t.hookUpMovement = t.hookDownMovement = t.bgInitMovement = t.initialAngle = t.out = t.land = t.drop = t.beforeDrop = t.swing = t.rotateLeft = t.rotateRight = t.flightLayer = t.flightCount = t.ropeHeight = t.cloudSize = t.blockHeight = t.blockWidth = t.blockCount = t.bgLinearGradientOffset = t.lineInitialOffset = t.bgImgOffset = t.hookNormal = t.hookUp = t.hookDown = t.gameScore = t.perfectCount = t.failedCount = t.successCount = t.hardMode = t.gameUserOption = t.gameStartNow = void 0;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.drawYellowString = t.addScore = t.addFailedCount = t.addSuccessCount = t.touchEventHandler = t.getHookStatus = t.getLandBlockVelocity = t.getSwingBlockVelocity = t.getAngleBase = t.getMoveDownValue = t.checkMoveDown = void 0;
    var n = function (e) {
    ...
    t.getMoveDownValue = function (e, t) {
        var i = t ? t.pixelsPerFrame : e.pixelsPerFrame.bind(e), a = e.getVariable(n.successCount),
            r = 2 * e.getVariable(n.blockHeight);
        return i(a <= 4 ? 1.25 * r : r)
    };
    t.getAngleBase = function (e) {
        var t = e.getVariable(n.successCount), i = e.getVariable(n.gameScore),
    ...
    t.getSwingBlockVelocity = function (e, t) {
        var i, a = e.getVariable(n.successCount), r = e.getVariable(n.gameScore),
    ...
    t.getLandBlockVelocity = function (e, t) {
        var i = e.getVariable(n.successCount), a = e.getVariable(n.gameScore),
    ...
    t.addSuccessCount = function (e) {
        var t = e.getVariable(n.gameUserOption).setGameSuccess, i = e.getVariable(n.successCount) + 1;
    ...
    t.addFailedCount = function (e) {
        var t = e.getVariable(n.gameUserOption).setGameFailed, i = e.getVariable(n.failedCount) + 1;
    ...
    t.addScore = function (e, t) {
        var i = e.getVariable(n.gameUserOption), a = i.setGameScore, r = i.successScore, o = i.perfectScore,
            s = e.getVariable(n.perfectCount, 0), c = e.getVariable(n.gameScore), u = t ? s + 1 : 0,
            l = c + (r || 25) + (o || 25) * u;
        e.setVariable(n.gameScore, l), e.setVariable(n.perfectCount, u), a && a(l)
    };
    t.drawYellowString = function (e, t) {
        var i = t.string, n = t.size, a = t.x, r = t.y, o = t.textAlign, s = e.ctx, c = n, u = .1 * c;
        s.save(), s.beginPath();
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), Object.defineProperty(t, "Engine", {
        enumerable: !0,
        get: function () {
            return n.default
        }
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.addFlight = t.flightPainter = t.flightAction = void 0;
    ...
    var r = function (e, t) {
        var i = e.visible, n = e.ready, r = e.type;
        if (i) {
            var o = t.getVariable(a.cloudSize);
            if (!n) {
                var s = function (e, t) {
                    var i = e.width, n = e.height, r = e.utils.random, o = e.getVariable(a.cloudSize);
                    return {
                        bottomToTop: {x: i * r(.3, .7), y: n, vx: 0, vy: .7 * e.pixelsPerFrame(n) * -1},
                        leftToRight: {
                            x: -1 * o,
                            y: n * r(.3, .6),
                        ...
                        rightTopToLeft: {x: i, y: 0, vx: .6 * e.pixelsPerFrame(i) * -1, vy: .5 * e.pixelsPerFrame(n)}
                    }[t]
                }(t, r);
    ...
    t.blockAction = function (e, t, i) {
        var o = e, s = t.getVariable(a.ropeHeight);
        if (o.visible) {
            ...
            switch (o.status) {
                case a.swing:
                    t.getTimeMovement(a.hookDownMovement, [[e.y, e.y + s]], function (t) {
                        e.y = t
                    }, {name: "block"}), function (e, t, i) {
                        var r = t.getVariable(a.ropeHeight);
                        if (e.status === a.swing) {
                            var o = e, s = t.getVariable(a.initialAngle);
                ...
                case a.drop:
                    ...
                    }(e, c), d = c.y - e.height, h = function (e) {
                    ...
                    break;
                case a.land:
                    t.getTimeMovement(a.moveDownMovement, [[e.y, e.y + (0, n.getMoveDownValue)(t, {
                        pixelsPerFrame: function (e) {
                            return e / 2
                        }
                    })]], function (i) {
                        e.visible && (e.y = i, e.y > t.height && (e.visible = !1))
                    }, {name: e.name}), e.x += (0, n.getLandBlockVelocity)(t, i);
                    break;
                case a.rotateLeft:
                case a.rotateRight:
                    var v = o.status === a.rotateRight, m = t.pixelsPerFrame(4 * Math.PI),
                        p = v ? e.rotate > 1.3 : e.rotate < -1.3, y = v ? 1 : -1;
                    if (p) e.rotate += m / 8 * y, e.y += t.pixelsPerFrame(.7 * t.height), e.x += t.pixelsPerFrame(.3 * t.width) * y; else {
                        var b = (e.calWidth - e.outwardOffset) / e.calWidth;
                        b = b > .5 ? b : .5, e.rotate += m * b * y;
                        var w = e.originOutwardAngle + e.rotate, k = v ? c.collisionX + e.calWidth : c.x + e.calWidth,
                            O = c.y;
    ...
    var o = function (e, t) {
        var i = e.perfect, n = t.getImg(i ? "block-perfect" : "block");
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.startAnimate = t.endAnimate = void 0;
    var n = i(2), a = i(4), r = i(1), o = i(3), s = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
            var n = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(e, i) : {};
    ...
    t.endAnimate = function (e) {
        if (e.getVariable(s.gameStartNow)) {
            var t = e.getVariable(s.successCount, 0), i = e.getVariable(s.failedCount),
                n = e.getVariable(s.gameScore, 0), a = Number(t) > 99 ? .1 * e.width : 0;
            ...
            var o = e.getImg("score"), c = o.width, u = o.height, l = .35 * e.width, d = u * l / c;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.tutorialPainter = t.tutorialAction = void 0;
    var n = i(1), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
    ...
    t.tutorialAction = function (e, t, i) {
        var n = t.width, a = t.height, r = e.name;
        if (!e.ready) {
            e.ready = !0;
            var o = .2 * n;
    ...
    t.tutorialPainter = function (e, t) {
        if (!t.checkTimeMovement(a.tutorialMovement) && (0, n.getHookStatus)(t) === a.hookNormal) {
            var i = t.ctx, r = e.name, o = t.getImg(r);
            i.drawImage(o, e.x, e.y, e.width, e.height)
        }
    }
}, function (e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.hookPainter = t.hookAction = void 0;
    var n = i(1), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
    ...
    t.hookAction = function (e, t, i) {
        var r = t.getVariable(a.ropeHeight);
        e.ready || (e.x = t.width / 2, e.y = -1.5 * r, e.ready = !0), t.getTimeMovement(a.hookUpMovement, [[e.y, e.y - r]], function (t) {
            e.y = t
        }, {
            after: function () {
                e.y = -1.5 * r
            }
        }), t.getTimeMovement(a.hookDownMovement, [[e.y, e.y + r]], function (t) {
            e.y = t
        }, {name: "hook"});
    ...
    t.hookPainter = function (e, t) {
        var i = t.ctx, n = t.getVariable(a.ropeHeight), r = .1 * n, o = t.getImg("hook");
        i.save(), i.translate(e.x, e.y), i.rotate(2 * Math.PI - e.angle), i.translate(-e.x, -e.y), t.ctx.drawImage(o, e.x - r / 2, e.y, r, n + 5), i.restore()
    }
}, function (e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.cloudPainter = t.cloudAction = void 0;
    var n = i(1), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
    ...
    t.cloudAction = function (e, t) {
        if (!e.ready) {
            ...
            var i = t.width, o = t.height,
                s = [{x: .1 * i, y: .66 * -o}, {x: .65 * i, y: .33 * -o}, {x: .1 * i, y: 0}, {
                    x: .65 * i,
                    y: .33 * o
                }][e.index - 1];
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.linePainter = t.lineAction = void 0;
    var n = i(1), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
    ...
    t.lineAction = function (e, t, i) {
        var r = e;
        r.ready || (r.y = t.getVariable(a.lineInitialOffset), r.ready = !0, r.collisionX = t.width - t.getVariable(a.blockWidth)), t.getTimeMovement(a.moveDownMovement, [[e.y, e.y + (0, n.getMoveDownValue)(t, {
            pixelsPerFrame: function (e) {
                return e / 2
            }
        })]], function (t) {
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.background = t.backgroundLinearGradient = t.backgroundImg = void 0;
    var n = i(1), a = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
    ...
    var r = function (e) {
        var t = e.getImg("background"), i = t.width, r = t.height * e.width / i,
            o = e.getVariable(a.bgImgOffset, e.height - r);
        o > e.height || (e.getTimeMovement(a.moveDownMovement, [[o, o + (0, n.getMoveDownValue)(e, {
            pixelsPerFrame: function (e) {
                return e / 2
            }
        })]], function (e) {
            o = e
        }, {name: "background"}), e.getTimeMovement(a.bgInitMovement, [[o, o + r / 4]], function (e) {
            o = e
        }), e.setVariable(a.bgImgOffset, o), e.setVariable(a.lineInitialOffset, e.height - .394 * r), e.ctx.drawImage(t, 0, o, e.width, r))
    };
    t.backgroundImg = r;
    var o = function (e, t, i) {
        var n = t + 1 >= e.length ? e.length - 1 : t, a = e[n], r = e[n + 1 >= e.length - 1 ? n : n + 1],
            o = function (e) {
                var t = a[e], n = r[e];
        ...
        var s = parseInt(r / e.height, 10), c = r % e.height / e.height, u = o(i, s, c), l = o(i, s + 1, c);
    ...
    var a = function () {
        function e() {
            ...
            var i = t.name, n = t.painter, a = t.action;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.arraySwap = t.requestAnimationFrameTool = t.isTouchDevice = t.isFunction = t.randomPositiveNegative = t.random = t.getCurrentTime = void 0;
    var n = function () {
        return +new Date
    };
    t.getCurrentTime = n;
    ...
    var a,
        r = (a = 1e3 / 60, window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
    ...
    var n, a = function (e) {
        ...
        return t.default = e, t
    }(i(13)), r = (n = i(12)) && n.__esModule ? n : {default: n};
    ...
    var c = a.requestAnimationFrameTool, u = a.isFunction, l = a.isTouchDevice, d = function () {
        function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            if (function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), document.createElement("canvas").getContext) {
                var i = t.canvasId, n = t.debug, r = t.width, o = t.height, s = t.highResolution, c = t.loadLimit,
                    u = t.soundOn, d = r || window.innerWidth, h = o || window.innerHeight;
        ...
        var t, i, n;
        return t = e, (i = [{
            key: "addAudio", value: function (e, t) {
                ...
                if (this.soundOn) {
                    ...
                    a.src = t, this.assetsObj.audio[e] = a, a.addEventListener("error", function () {
                        i.assetsErrorQueue.push({name: e, src: t, retry: n + 1, type: "audio"})
                    }, !1), a.load()
                }
            }
        }, {
            key: "getAudio", value: function (e) {
                return this.assetsObj.audio[e]
            }
        }, {
            key: "playAudio", value: function (e) {
            ...
            key: "pauseAudio", value: function (e) {
                var t = this.getAudio(e);
                t && t.pause()
            }
        }, {
            key: "setVariable", value: function (e, t) {
                this.customVariable[e] = t
            }
        }, {
            key: "getVariable", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                    i = this.customVariable[e];
                return i || (null !== t ? (this.setVariable(e, t), t) : null)
            }
        }, {
            key: "addImg", value: function (e, t) {
                var i = this, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0;
                ...
                a.src = t, a.onload = function () {
                    ...
                    i.assetsErrorQueue.push({name: e, src: t, retry: n + 1, type: "image"})
                }
            }
        }, {
            key: "getImg", value: function (e) {
                return this.assetsObj.image[e]
            }
        }, {
            key: "animate", value: function (e) {
                var t = this, i = e - this.pausedTime, n = this;
            ...
            key: "debugLineX", value: function (e) {
                this.debugArr.push({type: "lineX", y: e})
            }
        }, {
            key: "debugLineY", value: function (e) {
                this.debugArr.push({type: "lineY", x: e})
            }
        }, {
            key: "debugDot", value: function (e, t) {
                this.debugArr.push({type: "dot", x: e, y: t})
            }
        }, {
            key: "drawDebug", value: function () {
                var e = this;
                this.debugArr.forEach(function (t) {
                    var i = t.type, n = t.x, a = t.y;
                    switch (i) {
                        case"dot":
                            e.drawDebugDot(n, a);
                            break;
            ...
            key: "drawDebugLine", value: function (e, t) {
                var i, n, a = [0, t], r = [this.width, t];
            ...
            key: "drawDebugDot", value: function (e, t) {
            ...
            key: "updateFps", value: function (e) {
                0 === this.lastTime ? this.fps = 60 : this.fps = 1e3 / (e - this.lastTime)
            }
        }, {
            key: "pixelsPerFrame", value: function (e) {
                return e / this.fps
            }
        }, {
            ...
            key: "getTimeMovement", value: function (e, t, i) {
                var n = this, a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, o = a.before,
                    s = a.after, c = r.default[a.easing || "linear"], u = a.name || "default", l = this.timeMovement[e];
                if (l) {
                    l.processing || ("hook" === a.name && console.log(t), this.timeMovementStartArr.push(e), l.store[u] = [], t.forEach(function (e) {
                        l.store[u].push({start: parseFloat(e[0]), end: parseFloat(e[1])})
                    }), o && o());
                    var d = function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], t = l.duration, a = t;
                        if (!e) {
                            var r = n.utils.getCurrentTime(), o = l.startTime;
                            a = r - o
                        }
            ...
            key: "checkTimeMovement", value: function (e) {
                var t = this.timeMovement[e] || {};
                return this.utils.getCurrentTime() <= t.endTime
            }
        }, {
            key: "setTimeMovement", value: function (e, t) {
                var i = this.utils.getCurrentTime();
                this.timeMovement[e] = {startTime: i, endTime: i + t, duration: t, store: {}}
            }
        }, {
            ...
            key: "removeInstance", value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.defaultLayer;
            ...
            key: "updateInstances", value: function (e) {
                var t = this;
            ...
            key: "addKeyUpListener", value: function (e, t) {
                this.keyUpListeners[e] = t
            }
        }, {
            key: "addKeyDownListener", value: function (e, t) {
                this.keyDownListeners[e] = t
            }
        }, {
            key: "addKeyPressListener", value: function (e, t) {
                this.keyPressListeners[e] = t
            }
        }, {
            key: "findKeyListener", value: function (e, t) {
                return "keyup" === t ? this.keyUpListeners[e] : "keydown" === t ? this.keyDownListeners[e] : this.keyPressListeners[e]
            }
        }, {
            key: "keyListener", value: function (e, t) {
                var i;
                switch (e.keyCode) {
                    case 13:
                        i = "enter";
            ...
            key: "load", value: function (e, t) {
                var i = this, n = setInterval(function () {
                    ...
                    t && u(t) && t({
                        ...
                        var t = e.retry, n = e.name, a = e.src, r = e.type;
    ...
    "use strict";
    var n = i(2), a = i(1), r = i(10), o = i(9), s = i(8), c = i(7), u = i(6), l = function (e) {
        if (e && e.__esModule) return e;
        var t = {};
        if (null != e) for (var i in e) if (Object.prototype.hasOwnProperty.call(e, i)) {
            var n = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(e, i) : {};
    ...
    window.TowerGame = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.width, i = e.height,
            h = e.canvasId, g = e.soundOn,
            f = new n.Engine({canvasId: h, highResolution: !0, width: t, height: i, soundOn: g}), v = function (e) {
        ...
        for (var y = 1; y <= 4; y += 1) {
            var b = new n.Instance({name: "cloud_".concat(y), action: s.cloudAction, painter: s.cloudPainter});
            b.index = y, b.count = 5 - y, f.addInstance(b)
        }
        var w = new n.Instance({name: "line", action: o.lineAction, painter: o.linePainter});
        f.addInstance(w);
        var k = new n.Instance({name: "hook", action: c.hookAction, painter: c.hookPainter});
        return f.addInstance(k), f.startAnimate = d.startAnimate, f.endAnimate = d.endAnimate, f.paintUnderInstance = r.background, f.addKeyDownListener("enter", function () {
            ...
            var e = new n.Instance({name: "tutorial", action: u.tutorialAction, painter: u.tutorialPainter});
            f.addInstance(e);
            var t = new n.Instance({name: "tutorial-arrow", action: u.tutorialAction, painter: u.tutorialPainter});
